...
<main class="container">
    ...
    <form action="{{ route('admin.genre.update',$genre->slug) }}" method="POST" class="row justify-content-center music" enctype='multipart/form-data'>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" placeholder="Tambahkan Penyanyi / Band" name="title" value="{{ $genre->name }}">
            @error('title')
        ...
        <div class="mb-3">
            ...
            <img src="{{ $genre->thumbnail }}" alt="{{ $genre->title }}" class="img-thumbnail w-15">
