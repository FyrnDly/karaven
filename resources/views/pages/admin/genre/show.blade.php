...
<main class="container">
	...
	<div class="success-feedback" role="alert">
	    <p>Genre <b>{{ session('genre')->name }}</b> berhasil ditambahkan</p>
	</div>
	@endif
	@if (session('status') === 'update')
	<div class="success-feedback" role="alert">
	    <p>Genre <b>{{ session('genre')->name }}</b> berhasil diperbarui</p>
	</div>
	@endif
	@if (session('status') === 'destroy')
	<div class="invalid-feedback d-block" role="alert">
	    <p>Genre <b>{{ session('genre')->name; }}</b> berhasil dihapus</p>
	</div>
	@endif
